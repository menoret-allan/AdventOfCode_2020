module Inputs
    ...
    let smallSet = """light red bags contain 1 bright white bag, 2 muted yellow bags.
...
dotted black bags contain no other bags."""
    ...
    let smallSet2 = """light red bags contain 1 bright white bag, 2 muted yellow bags.
dark orange bags contain 3 bright white bags, 4 muted yellow bags.
bright white bags contain 1 shiny gold bag.
muted yellow bags contain 2 shiny gold bags, 9 faded blue bags.
shiny gold bags contain 1 dark olive bag, 2 vibrant plum bags.
dark olive bags contain 3 faded blue bags, 4 dotted black bags.
vibrant plum bags contain 5 faded blue bags, 6 light red bags.
faded blue bags contain no other bags.
dotted black bags contain no other bags."""

    let smallSet3 = """shiny gold bags contain 2 dark red bags.
...
dark violet bags contain no other bags."""
    ...
    let bigSet = """dotted blue bags contain 5 wavy green bags, 3 pale beige bags.
